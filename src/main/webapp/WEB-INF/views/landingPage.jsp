    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="img/cherry-mobile-omega-hd-features.jpg" alt="First slide">
          <div class="container">
        ...
        <div class="item">
          <img src="img/Big-Data-Return-on-Investment-What-2014-Has-in-Store.jpg" alt="Second slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>Big Data</h1>
        ...
        <div class="item">
          <img src="img/9fe6ca8c49bd0430a72711b4db0691f1.jpg" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
              <h1>IoT/IoE</h1>
      ...
      <a class="left carousel-control" href="./Carousel Template for Bootstrap_files/Carousel Template for Bootstrap.html" role="button" data-slide="prev">
        <span class="glyphicon glyphicon-chevron-left"></span>
        <span class="sr-only">Previous</span>
      </a>
      <a class="right carousel-control" href="./Carousel Template for Bootstrap_files/Carousel Template for Bootstrap.html" role="button" data-slide="next">
